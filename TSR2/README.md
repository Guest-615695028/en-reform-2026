...
4. The letter G usually represents the sound /ɡ/ as in **gun**, along with the sound /d͡ʒ/ before the letters E, I or Y in Latinate words. Exceptions to this rule are often marked in TS by inserting an U as in **guide**; if not, _get_ is **ghet**, whereas _girl_ is **ghirl**.
   ...
   - In cases where the sound is /d͡ʒ/ but not folloïng a monographic long vocal, TSR has a digraph DG as in **badger**, **lodger**, **fudge** etc..
...
5. The Letter S: It normally represents the sound /s/ as in **sound**, but allso /z/ as in **please**.
   - Based on TS formulae, S represents /s/:
      ...
      - After L, M, N, R but before vocal: **else**, **defense**, **parse**;
      - In the suffix -son.
...
## Notes
Norman-French words and academic words that cater to the [Great vocal Shift](https://en.wikipedia.org/wiki/Great_vocal_Shift), are not considered loanwords layerwise, neither do the Jappanese and Koreans to Chinese imports before [the Fall of Chinese Empire to Mongols](https://en.wikipedia.org/wiki/Battle_of_Yamen).
