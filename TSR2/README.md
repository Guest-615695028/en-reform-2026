...
Planning a "stepwise" reform, it noted that spelling should be changed, most of which are originally the overt act of a lone writer folloed at first by minorrity. Thus, people are hartened to "point the way" and "set the example" by writing the reformed spellings as the handbook set forth ([confer Wikipedia](https://en.wikipedia.org/wiki/Simplified_Spelling_Board)).
...
1. Magic E rule: accented vowels are usually long in `VCV`, but short in `VCC|VC$`, as usual in TS:
   ...
   - Magic E can be stedded by all vowel letters: A, E, I, O, U, Y.
   - Single B/C/D/F/G/K/P/S/T folloed by L/R lengthens the leading vowel.
2. Twicing (dubbling) rule: Consonants are twiced to note that the leading vowel is short and accented when -ed, -er, -est, -ing and others are attached, whereas K is to CK, soft G to DG. especially those at morphemic bounds. Otherwise are there _programme_ to **program**.
3. The combination **al(l)** is one of the most difficult areas to attempt codication of the underlying rules of TS.
   ...
   - In a few common words beginning with AL givving a meaning of totality and sounding /ɔːl/, are replaced by ALL. If this precedes a vowel, a hyfen is added.
      - _albeit_ → **all-be-it**,
